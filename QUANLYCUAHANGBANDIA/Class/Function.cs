...
namespace Quan_ly_cua_hang_ban_dia.Class
{
    class Functions
    {
        ...
        public static void Connect()
        {
            ...
            connString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\CSLT 2\Quan ly cua hang ban dia\Quan ly cua hang ban dia\Database\QuanLyBanDia.mdf;Integrated Security=True;Connect Timeout=30";
